/*
 * @file ui_weather.c
 * @brief UI screen for weather display
 *
 * This file implements the UI for displaying weather information. It shows
 * the city name, current temperature, a weather icon (e.g., cloudy), and
 * a brief weather description including min/max temperatures.
...
// LVGL object for the weather UI page
static lv_obj_t *page;
// Callback function to execute when returning from this UI
static ret_cb_t return_callback;

/**
 * @brief Event callback for the weather page.
 *
 * This function handles events generated by the weather page object.
 ...
 * - `LV_EVENT_LONG_PRESSED`: Triggers the deletion of the weather UI and
 ...
 * It sets up the main page with a background weather image. Over this, it displays:
 * - City name.
 * - Current temperature.
 * - A weather icon (e.g., cloudy).
 * - A text description of the weather state, including min/max temperatures.
 * Entry animations are applied to various elements for a dynamic appearance.
 * The page is added to the encoder group for navigation, and event callbacks
 * are registered for interaction (e.g., long press to exit).
 ...
 * with all its children (labels, images).
